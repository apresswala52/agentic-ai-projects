...
This example, unmodified, will run the create a `propose.md` file having arguments in favour of the motion & `oppose.md` file having arguments against the motion. Finally, a `report.md` file will be created by the judge that will contain details of the winner.
